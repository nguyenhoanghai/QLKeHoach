...
GPRO.Receipt = function () {
    ...
    function Edit(Id) {
        ...
        if (Receipt.Status) {
            ...
            $('#modal1 #btnSave,#modal1 #btnSubmit').addClass('hide');
        }
    ...
    function InitPopup() {
        ...
        $('#modal1 #btnCancel').click(function () {
            ...
            $('#modal1 #btnSave,#modal1 #btnSubmit').removeClass('hide');
            $('select').formSelect();
            M.updateTextFields();
        });
    }
    ...
    function DrawDetailTable() {
        ...
        if (Global.Data.selectedReceipt && Global.Data.selectedReceipt.Status) {
            $('input, select').prop("disabled", true);
            M.updateTextFields();
            $('select').formSelect();
        }
